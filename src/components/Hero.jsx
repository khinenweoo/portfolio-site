  ...
  return (
    <div id='hero' className='w-full flex flex-col items-center px-4 sm:px-12 lg:px-24 xl:px-40'>
      <div className="relative w-full h-screen overflow-hidden z-0">
        ...
        {/* Star 2 */}
        <div className="absolute top-[20%] right-[16%] -translate-x-1/2 -translate-y-1/2">
          <StarShape className="w-6 h-6 text-white drop-shadow-[0_0_8px_rgba(255,255,255,0.8)]" />
        </div>

        {/* content */}
        <div className='w-full max-w-2xl py-6 md:py-14 mx-auto h-1/2 translate-y-1/2 bg-[#101111] rounded-md'>
